...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    prefix_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'rv'>;
    hero_title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Personal Web Documentation'>;
    hero_subtitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Just My Documentation of the Journey.'>;
    hero_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    subfix_title: Schema.Attribute.String &
      Schema.Attribute.Required &
